...
echo -e ""
echo -e "\033[0;33m  ${WB}Hari ini\033[0;36m ($DATE) \033[0;33m  Bulan\033[0;36m ($(date +%Y/%B))${NC}  "
echo -e "\033[0;33m  Total: \033[0;32m$daily_usage${NC}         \033[0;33m Total: \033[0;32m$monthly_usage${NC}   "
echo -e ""
echo -e "${BLUE}─────────────────────────────────────────────────────────────${NC}"
