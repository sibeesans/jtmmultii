...
echo -e ""
echo -e "\033[0;37m  ${WB}Hari ini\033[0;33m ($DATE) \033[0;37m  Bulan\033[0;33m ($(date +%Y/%B))${NC}  "
echo -e "\033[0;37m  Total: ${BIRed}$daily_usage${NC}                \033[0;37m Total: \033[0;33m$monthly_usage${NC}   "
echo -e "${BLUE}─────────────────────────────────────────────────────────────${NC}"
