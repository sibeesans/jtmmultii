...
echo -e "${BLUE}=============================="
echo -e "${NC}GET-WS wss://${domain}/ HTTP/1.1[crlf]Host: ${domain}[crlf]Upgrade: websocket[crlf][crlf]"
echo -e "${BLUE}=============================="
echo -e "${ORANGE}Payload Websocket No TLS"
echo -e "${BLUE}=============================="
echo -e "${NC}GET / HTTP/1.1[crlf]Host: ${domain}[crlf]Upgrade: websocket[crlf][crlf]"
echo -e "${BLUE}=============================="
