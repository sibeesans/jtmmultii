...
UPDATE="https://raw.githubusercontent.com/Jatimpark/multi/main/"
#BOT="https://raw.githubusercontent.com/Jatimpark/multi/main/"
...
echo -e " ${YELLOW}TOTAL AMOUNT OF RAM ${NC} :${Cyan} $tram MB"
echo -e " ${YELLOW}USED RAM            ${NC} :${Cyan} $uram MB"
echo -e " ${YELLOW}FREE RAM             ${NC}:${Cyan} $fram MB"
...
echo -e " ${YELLOW}EXP SCRIPT ${NC}          : ${Cyan}LIFETIME ${NC}"
echo -e "${BLUE}┌────────────────────────────────────────────────────────────┐${NC}"
echo -e "${BLUE}│  \033[0m ${BOLD}${YELLOW}SSH     VMESS       VLESS      TROJAN       SHADOWSOCKS$NC ${BLUE} │"
echo -e "${BLUE}│  \033[0m ${NC} $ssh1       $vma           $vla          $trb              $ssa   $NC         ${BLUE} │"
echo -e "${BLUE}└────────────────────────────────────────────────────────────┘${NC}"
...
echo -e " ${BICyan}[${BIWhite}03${BICyan}]${BIRed} •${NC} ${CYAN}VLESS MENU      $NC  ${BICyan}[${BIWhite}13${BICyan}]${BIRed} • ${NC}${CYAN}RESTART BANNER $NC"
echo -e " ${BICyan}[${BIWhite}04${BICyan}]${BIRed} •${NC} ${CYAN}TROJAN MENU     $NC  ${BICyan}[${BIWhite}14${BICyan}]${BIRed} • ${NC}${CYAN}RESTART SERVICE $NC"
